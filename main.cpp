...
//Remove clients
//varje update : kolla alla clients i vector om timestamp är över (ex 10 sec) eller keepalive = false, ta bort client
//ta bort client = stäng socket, ta bort ur listan



//HANDLE INVALID GET REQUESTS:
//if "/.." finns i GET, skicka forbidden eller 404 eller nått
